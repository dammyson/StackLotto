  ...
  generateNumber(){
    this.refs[TEXT_INPUT_REF].blur();
        ...
        for(let i = 0; i < this.state.number_quick; i++){
          GameArray.push(this.getnumbers(3))
        }
        var instant_array = []
        ...
        <Content>
          <View style={styles.backgroundImage}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View>
                <Text style={{ fontSize: 15, textAlign: 'center', margin: 20, color: '#fff' }}>Select 3 numbers from 0-9 OR Choose Quick Pick Draw date 2020-01-20 16:00:00</Text>
              </View>
...
<TouchableOpacity onPress={() => this.play()} style={{backgroundColor:color.secondary_color, height: 50,  width: Dimensions.get('window').width - 60, flexDirection: 'row', margin: 30, alignItems: 'center', justifyContent: 'center', }}>
  ...
  play() {
    ...
    const gamesDetails = { ticket: 100, type: 3, exact_order: false, }
