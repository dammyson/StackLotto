        ...
        <Content>
          <View style={styles.backgroundImage}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View>
                <Text style={{ fontSize: 13, textAlign: 'center', margin: 20, color: '#fff' }}>Select 6 number from 1-49 OR Choose Quick Pick Draw date 2020-01-20 16:00:00</Text>
              </View>
...
<View style={{ alignItems: 'center', justifyContent: 'center', }}>
              ...
              <View style={{ flexDirection: 'row', marginBottom: 20, marginTop: 40, }}>
                ...
                {this.state.multipleSelectedData.length == 6 ?
                  <TouchableOpacity onPress={() => this.addTicket()} style={{ height: 40, flexDirection: 'row', marginRight: 10, marginLeft: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: color.secondary_color }}>
                    <Text style={{ color: '#fff', fontSize: 12, marginRight: 15, marginLeft: 15, fontWeight: '600' }}>Add </Text>
                  </TouchableOpacity>
