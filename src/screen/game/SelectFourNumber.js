...
export default class SelectFourNumber extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Container style={{ backgroundColor: color.primary_color }}>
        <Navbar right={right} left={left} title='4/25' bg='#fff' />
        <Content>
          <View style={styles.backgroundImage}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View>
                <Text style={{ fontSize: 13, textAlign: 'center', margin: 20, color: '#fff' }}>Select 4 number from 1-25 OR Choose Quick Pick Draw date 2020-01-20 16:00:00</Text>
              </View>
